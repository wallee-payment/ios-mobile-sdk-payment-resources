Pod::Spec.new do |s|
  ...
  s.version          = '7.0.0'
  s.summary          = 'Payment resources libraries! 7.0.0'
  s.description      = 'Resources needed for payment SDK 7.0.0'
  ...
  s.vendored_frameworks = ['Specs/PaymentResources/7.0.0/TwintSDK.xcframework']
