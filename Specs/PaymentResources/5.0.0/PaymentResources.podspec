Pod::Spec.new do |s|
  ...
  s.version          = '5.0.0'
  s.summary          = 'Payment resources libraries! 5.0.0'
  s.description      = 'Resources needed for payment SDK 5.0.0'
  ...
  s.vendored_frameworks = ['Specs/PaymentResources/5.0.0/TwintSDK.xcframework', 'Specs/PaymentResources/5.0.0/ThreeDS_SDK.xcframework']
